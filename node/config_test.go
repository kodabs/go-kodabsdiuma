...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "gkds.ipc", false, filepath.Join(os.TempDir(), "gkds.ipc")},
		{"data", "gkds.ipc", false, "data/gkds.ipc"},
		{"data", "./gkds.ipc", false, "./gkds.ipc"},
		{"data", "/gkds.ipc", false, "/gkds.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "gkds.ipc", true, `\\.\pipe\gkds.ipc`},
		{"data", "gkds.ipc", true, `\\.\pipe\gkds.ipc`},
		{"data", `\\.\pipe\gkds.ipc`, true, `\\.\pipe\gkds.ipc`},
	}
