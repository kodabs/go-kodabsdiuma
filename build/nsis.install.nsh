Name "gkds ${MAJORVERSION}.${MINORVERSION}.${BUILDVERSION}" # VERSION variables set through command line arguments
InstallDir "$InstDir"
OutFile "${OUTPUTFILE}" # set through command line arguments

# Links for "Add/Remove Programs"
!define HELPURL "https://github.com/kodabs/go-kodabsdiuma/issues"
!define UPDATEURL "https://github.com/kodabs/go-kodabsdiuma/releases"
!define ABOUTURL "https://github.com/kodabs/go-kodabsdiuma#ethereum-go"
...
# Install gkds binary
Section "Gkds" GETH_IDX
  SetOutPath $INSTDIR
  file {{.Gkds}}

  # Create start menu launcher
  createDirectory "$SMPROGRAMS\${APPNAME}"
  createShortCut "$SMPROGRAMS\${APPNAME}\${APPNAME}.lnk" "$INSTDIR\gkds.exe" "--fast" "--cache=512"
  createShortCut "$SMPROGRAMS\${APPNAME}\Attach.lnk" "$INSTDIR\gkds.exe" "attach" "" ""
  createShortCut "$SMPROGRAMS\${APPNAME}\Uninstall.lnk" "$INSTDIR\uninstall.exe" "" "" ""

  # Firewall - remove rules (if exists)
  SimpleFC::AdvRemoveRule "Gkds incoming peers (TCP:31540)"
  SimpleFC::AdvRemoveRule "Gkds outgoing peers (TCP:31540)"
  SimpleFC::AdvRemoveRule "Gkds UDP discovery (UDP:31540)"

  # Firewall - add rules
  SimpleFC::AdvAddRule "Gkds incoming peers (TCP:31540)" ""  6 1 1 2147483647 1 "$INSTDIR\gkds.exe" "" "" "Ethereum" 31540 "" "" ""
  SimpleFC::AdvAddRule "Gkds outgoing peers (TCP:31540)" ""  6 2 1 2147483647 1 "$INSTDIR\gkds.exe" "" "" "Ethereum" "" 31540 "" ""
  SimpleFC::AdvAddRule "Gkds UDP discovery (UDP:31540)" "" 17 2 1 2147483647 1 "$INSTDIR\gkds.exe" "" "" "Ethereum" "" 31540 "" ""

  # Set default IPC endpoint (https://github.com/ethereum/EIPs/issues/147)
  ${EnvVarUpdate} $0 "ETHEREUM_SOCKET" "R" "HKLM" "\\.\pipe\gkds.ipc"
  ${EnvVarUpdate} $0 "ETHEREUM_SOCKET" "A" "HKLM" "\\.\pipe\gkds.ipc"
