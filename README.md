...
|   `puppeth`   | a CLI wizard that aids in creating a new Kodabsdium network.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
...
As a developer, sooner rather than later you'll want to start interacting with `gkds` and the
